...
impl BaseHeaderClause {
    /// Get the value of the header clause as a raw string from the OBO header.
    ///
    /// Example:
    ...
    fn raw_value(&self) -> PyResult<String> {
        NotImplementedError::into("BaseHeaderClause.value")
    }
}
...
impl TreatXrefsAsGenusDifferentiaClause {
    ...
    fn raw_value(&self) -> PyResult<String> {
        Ok(format!("{} {} {}", self.idspace, self.relation, self.filler))
    }
}
...
impl TreatXrefsAsRelationshipClause {
    ...
    fn raw_value(&self) -> PyResult<String> {
        Ok(format!("{} {}", self.idspace, self.relation))
    }
}
